...
const DetailsHeader = ({
  ...
  useEffect(() => {
    mediaAnalysisCallback(mediaAnalysisOpen);
  }, [mediaAnalysisCallback, mediaAnalysisOpen]);
  ...
  const onXAxisClick = name => {
    console.log('onXAxisClick', name);
    setMediaAnalysisOpen(true);
    return true;
  };
            ...
            <div className="platform__body">
              <>
                ...
                <div className="matchValuation__graph">
                  ...
                  {activeTab == 'FET106' && activeCategory == 'SEG102' && (
        ...
        <div className="socialGeo_cardsUi">
          ...
          >
            ...
            <ModalAlert
              ...
              filtersubplatform={this.props.filtersubplatform}
              // data={data}
              // dataKey="uv"
              // pass table data array to modal to loop over
              // tableData={}
